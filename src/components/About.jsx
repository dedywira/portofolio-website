...
const About = () => {
  return (
    <>
      ...
      <motion.div variants={fadeIn("", "", 0.1, 1)} className='mt-4 flex items-center space-x-7'>
        <a href='https://www.linkedin.com/in/dedywd/' target='_blank'>
          {/* Linkedin */}
          <svg
        ...
        <a href='https://www.behance.net/dedywirad' target='_blank'>
          {/* Behance */}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-6 w-6"
        ...
        <a href='https://dribbble.com/dedywd' target='_blank'>
          {/* Dribbble */}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-6 w-6"
        ...
        <a href='https://github.com/dedywira' target='_blank'>
          {/* Github */}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-6 w-6"
        ...
        <a href='https://www.youtube.com/@dedywd_' target='_blank'>
          {/* Youtube */}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-6 w-6"
        ...
        <a href='https://www.instagram.com/dedywd.project/' target='_blank'>
          {/* Instagram */}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-6 w-6"
