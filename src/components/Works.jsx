...
import {github, link, study} from '../assets';
    ...
    <>
      ...
      <div className='w-full flex'>
        <motion.p
          ...
          className='mt-3 text-secondary text-[16px] max-w-xl leading-[30px]'
        >
          Following projects showcases my skills and experience through
          real-world examples of my work. Each project is briefly described with
          links to full study case or demos in it. It reflects my
